<html lang="he">
  ...
  <body id="bod">
       ...
       <div class="app"  dir="rtl">
          <div class="top-row" style="margin-bottom: 50px;">
              ...
              <div class="site-title-content">
                  <h1 class="site-title">אגף משאבי אנוש - עיריית רמת גן</h1>
              </div>
          </div>
    ...
    הרינו מאשרים את קבלת פנייתך.<br>
			  במידה והגשת את כל המסמכים הנדרשים במלואם, מועמדותך תיבחן ובמידת הצורך ונפנה אליך.<br>
          </p>
        </div>
         <div class="signature">
