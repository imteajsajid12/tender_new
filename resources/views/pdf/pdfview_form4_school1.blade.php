<html lang="he">
  ...
  <body id="bod">
      <p style="margin-bottom: 30px;line-height: 2.083;margin-top: 3px">
        מזכירות ביה"ס: {{$msg}} <br> מועצה איזורית לכיש<br> א.ג.נ.,
      </p>
      ...
      <p style="margin-top: 20px;line-height: 30px;">
          ...
          לשנת הלימודים: תש"פ     כיתה: {{$metaJson['grade1']}}   בית ספר: {{$msg}}   כתובת בית הספר: @if(isset($metaJson['departmentdetails'][1])){{$metaJson['departmentdetails'][1]}} @endif   טלפון בית הספר: @if(isset($metaJson['departmentdetails'][2])){{$metaJson['departmentdetails'][2]}} @endif<br><br>
      </p>
