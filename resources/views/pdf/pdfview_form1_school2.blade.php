<html lang="he">
  ...
  <body id="bod">
      ...
      @for($i=1; $i <= 1; $i++)
        הרינו לאשר כי התלמיד/ה: {{$metaJson['cn'.$i]}} {{$metaJson['cf'.$i]}} תעודת זהות:  {{$metaJson['id'.$i]}}  &nbsp;&nbsp;&nbsp; תאריך לידה: {{$metaJson['date_birth'.$i]}}  &nbsp;&nbsp;&nbsp;  כיתה: {{$metaJson['grade'.$i]}}<br>
        הינו/ה תושב/ת: מועצה איזורית לכיש<br>
        התלמיד מופנה/ית אליכם לשיבוץ חוץ<br><br>
