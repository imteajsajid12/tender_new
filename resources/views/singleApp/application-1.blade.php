...
@elseif($application->st == 3)
    ...
    <div class="mt-3 mb-5" style="overflow: hidden;padding-bottom: 10px" id="buttons-content">
        ...
        @if(\App\User::check_auth_user_AppPermission($application,3))
            <a href="#" class="apps-btn btn float-right ml-3" onclick="show_text_area(this, {{$application->id}}, 2)">אישור עם התחייבות</a>
            <a href="#" class="apps-btn btn float-right ml-3" onclick="send_app({{$application->id}}, 2)">אישור בלי התחייבות</a>
