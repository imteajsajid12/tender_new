                ...
                <div class="row top-row">
                    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-8 text-left">
                        <h1 class="site-title" style="color: #4eb053;margin-top: 50px;line-height: 40px;text-align: right;">
                          תודה, בקשתך נקלטה והועברה למועצה.
                        </h1>
                        <h4 style="text-align: right; margin-top: 15px; font-size: 22px; ">
                            לצפייה בטופס שנשלח לערייה, <a href="{{url('/')}}/upload/{{$failname}}.pdf" target="_blank">לחץ כאן</a>
                        </h4>
                    </div>
