...
<span>
                <input type="checkbox" name="form3_ch1" class="" value="2" id="educ_school">
                <span class="caption max-w180">אני או אחד מהוריי נולדנו באתיופיה.</span>
                </span>
            </div>
            <div class="faind_line">
<span>
                <input type="checkbox" name="form3_ch2" class="" value="2" id="educ_school">
        ...
        <div class="input-control"  style="width:300px">
            ...
            <div>
                <a href="#" id="rfile-upload-{{$key}}" class="rm" style="display:none" onclick="removeFile({{$key}});return false;"><i
                            class="trash-icon"></i></a>
                <label for="file-upload-{{$key}}" class="btn btn-default pda success hidden-lg hidden-md hidden-sm"></label>
                <label for="file-upload-{{$key}}" class="btn btn-default  success">בחר קובץ</label>
        ...
        <div class="faind_line">
<span>
                <input type="checkbox" name="relative_confirm2" class="" value="2" id="educ_school">
