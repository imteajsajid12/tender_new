    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col pl-0 logo">
                <a href="#" class="logo__link">
                    <img src="{{asset('img/logo-b.png')}}" style="width: 175px;"/>
                </a>
            </div>
		...
		<div class="row footer">
            <div class="col-12">
                <ul>
                    <li>בניין העירייה</li>
                    <li>קניון נעימי, דרך רבין 2, בית שמש</li>
                    <li>ט.ל: 1-700-500-521</li>
					<li>פקס: 02-9909741</li>
                </ul>
            </div>
            <div class="col-12">
                <ul>
                    <li>www.betshemesh.muni.il</li>
                    <li>Bshemesh@mgar.co.il</li>
                </ul>
            </div>
        </div>
		-->
