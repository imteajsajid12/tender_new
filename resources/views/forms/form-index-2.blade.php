                    ...
                    <div class="input-control">
                        <label>
                            ...
                            <label class="radio">
                                ...
                                <span class="caption"> יש לי קרובי משפחה המועסקים בעיריית אשדוד או המכהנים כחברי מועצת הרשות, לרבות קרבת משפחה חורגת.</span>
                            </label>
                        </label>
                    </div>
            ...
            <div style="margin-right:15px">
                ...
                <div class="faind_line" style="display: flex">
                    <div style="position:relative;top:-6px;margin-left:5px"><input type="checkbox"
                                                                                   ...
                                                                                   value="2" id="educ_school"></div>
                    <div class="caption max-w180 bold"> ידוע לי כי מסירת פרטים לא נכונים ו/או דיווח חלקי על קרובי משפחתי,
