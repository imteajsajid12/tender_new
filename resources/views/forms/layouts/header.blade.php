...
<head>
    ...
    <title>עיריית בית שמש - מחלקת משאבי אנוש</title>
    ...
    <script language="JavaScript">
        function closeLine(tag)
        {
            ...
            if (tag && tag.parentElement && tag.parentElement.style)
            {
                ...
                console.log('idd',idd);
                if ((idd ==='add_educ_block' || idd ==='language_block'))
                {
...
<div class="container">
    <div class="top-row" style="padding:20px 20px auto 20px; height:180px;  background:white; ">
        ...
        <div class="site-title-content" style="text-align:center;margin-left: 5px; margin-top:20px; width: 100%;">
            <h2 class="site-title">מנהל משאבי אנוש</h2>
            <h4 class="site-title" style="font-weight:400">טופס הגשת מועמדות למכרזי כוח אדם</h4>
