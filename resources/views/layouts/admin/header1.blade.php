...
<head>
    ...
    <script language="JavaScript">
        ...
        <div class="row">
            ...
            var commonHTML = `${options__list}<br>${jobDetails__option}<br><div class="row mx-2">${functional__level__list}${is_recommended_block}${is_test_required_block}</div><br><div class="col-12">
            ...
            if (tenderData && tenderData.conditions && tenderData.conditions.length > 0) {
                var docs = document.querySelectorAll('.editmodal *[id^="doc"]');
                docs.forEach(function(doc) {
                    var id = doc.id;
                    var headerDoc = doc.innerHTML;
                    ...
                    while (i < tenderData.conditions.length) {
                        //if(i % 2 == 0) {
                        if (tenderData.conditions[i].includes('=>') && !tenderData.conditions[i].includes(
                                'not_required') && !tenderData.conditions[i].includes('required') && !tenderData
                            .conditions[i].includes('cond_or') && !tenderData.conditions[i].includes('confirm')

                        ) {
                            header = tenderData.conditions[i].split("=>");
                            console.log('header', header);
                        } else {
                            console.log(header[1] + "===" + headerDoc);
                            if ((tenderData.conditions[i].includes('=>') && header[1] === headerDoc) && (
                                    tenderData.conditions[i].includes('') || tenderData.conditions[i].includes(
                                        'not_required') || tenderData.conditions[
                                        i].includes('required') || tenderData.conditions[i].includes(
                                        'cond_or') || tenderData.conditions[i].includes('confirm'))) {
                                var value = tenderData.conditions[i].split("=>");
                                con = {
                                    value: value[0],
                                    option: value[1]
                                };
                                console.log('value', value);
                                update_dublibe('emodal_cond_block_' + id, '_tender_add_cond_' + id, con, i);
                            }
                        }
                        i++;
                    }
        ...
        */
        async function createUpdateTender(mode, tenderid, duplicate = false) {
            ...
            for (let i = 0; i < cond_manual.length; i++) {
                var val2 = cond_manual[i] ? cond_manual[i].innerText : false;
                var obj2 = cond_manual[i].getAttribute("data-val");
                var header = obj2 !== '' ? $('#' + obj2).text() : false;
                console.log('cc1', val2, obj2, header);
                if (val2 && header) {
                    cline.push(val2 + '=>' + header);
                }

                var val1 = cond_manual[i] ? cond_manual[i].textContent : false;
                var cpos1 = val1.indexOf("תנאי סףיתרון");
                if (cpos1 != -1 && header.indexOf("דרישות נוספות") != -1) {
                    //counter1++;

                    val1 = val1.substring(0, cpos1);
                    var obj = '';
                    //let x = Number(3*counter1);
                    counter2 = counter2 + 4;
                    x = counter2 - 1;
                    ...
                    if (cond_manual_advantage[x] && cond_manual_advantage[x].checked) {
                        obj = val1 + '=>' + 'confirm';
                    }
                    if (obj) {
                        cline.push(obj);
                ...
                } else if (header.indexOf("דרישות נוספות") === -1) {
                    //counter1++;
                    val1 = val1.substring(0, cpos1);
                    var obj = '';
                    //let x = Number(2*counter1);
                    counter2 = counter2 + 3;
                    x = counter2 - 1;
                    if (cond_manual_advantage[x - 2] && cond_manual_advantage[x - 2].checked) {
                        obj = val1 + '=>' + 'required';
                    ...
                    <div class="modal-row">
                        ...
                        <div>
                            ...
                            <select id="pref_tender_brunch" class="max-280">
                                ...
                                <option value="אגף הנדסה">אגף הנדסה</option>
                                <option value="אגף נכסים">אגף נכסים</option>
                                <option value="אגף תכנון">אגף תכנון</option>
                                <option value="אגף תשתיות">אגף תשתיות</option>
                                <option value="אגף כספים">אגף כספים</option>
                                <option value="אגף חינוך">אגף חינוך</option>
                                <option value="אגף שפ''ע">אגף שפ''ע</option>
                                <option value="אגף ביטחון ואכיפה">אגף ביטחון ואכיפה</option>
                                <option value="אגף שירותים חברתיים">אגף שירותים חברתיים</option>
                                <option value="אגף משאבי אנוש">אגף משאבי אנוש</option>
                                <option value="אגף מערכות מידע ומחשוב">אגף מערכות מידע ומחשוב</option>
                                <!--<option value="אגף קש''ת">אגף קש''ת</option>-->

                                <option value="אגף רכש ולוגיסטיקה">אגף רכש ולוגיסטיקה</option>
                                <option value="מחלקת תרבות">מחלקת תרבות</option>
                                <option value="מחלקת משק ותחזוקה">מחלקת משק ותחזוקה</option>
                                <option value="השירות המשפטי">השירות המשפטי</option>
                                <option value="הנהלה">הנהלה</option>
                                <option value="לשכת ראש העיר">לשכת ראש העיר</option>
                                <option value="לשכת מנכ''ל">לשכת מנכ''ל</option>
                                <option value="מחלקת בטיחות וגיהות">מחלקת בטיחות וגיהות</option>
                                <option value="מחלקת קידום הקהילה הגאה">מחלקת קידום הקהילה הגאה</option>
                                <option value="מזכירות העירייה">מזכירות העירייה</option>
                                <option value="מחלקת תכנון וארגון עירוני">מחלקת תכנון וארגון עירוני</option>
                                <option value="מחלקת ספריות">מחלקת ספריות</option>
                                <option value="מבקר העירייה">מבקר העירייה</option>
                                <option value="אגף פיתוח כלכלי">אגף פיתוח כלכלי</option>
                                <option value="מנהלת הבורסה">מנהלת הבורסה</option>
                                <option value="אגף התנועה">אגף התנועה</option>
                                <option value="אגף קשרי קהילה">אגף קשרי קהילה</option>
                                <option value="אגף דוברות">אגף דוברות</option>
                            </select>
                        </div>
                    ...
                    <div>
                        ...
                        <div id="pref_cond_line">
                            <input type="text" id="pref_tender_add_cond_doc1" required="" class="max-440"
                                style="width: 89%;"
                                onblur="new_dublibe('pref_cond_block_doc1', '_tender_add_cond_doc1')">
                            <button class="btn"
                    ...
                    <div>
                        ...
                        <div id="pref_cond_line">
                            <input type="text" id="pref_tender_add_cond_doc2" required="" class="max-440"
                                style="width: 89%;"
                                onblur="new_dublibe('pref_cond_block_doc2', '_tender_add_cond_doc2')">
                            <button class="btn"
                    ...
                    <div>
                        ...
                        <div id="pref_cond_line">
                            <input type="text" id="pref_tender_add_cond_doc3" required="" class="max-440"
                                style="width: 89%;"
                                onblur="new_dublibe('pref_cond_block_doc3', '_tender_add_cond_doc3')">
                            <button class="btn"
                    ...
                    <div>
                        ...
                        <div id="pref_cond_line">
                            <input type="text" id="pref_tender_add_cond_doc4" required="" class="max-440"
                                style="width: 89%;"
                                onblur="new_dublibe('pref_cond_block_doc4', '_tender_add_cond_doc4')">
                            <button class="btn"
